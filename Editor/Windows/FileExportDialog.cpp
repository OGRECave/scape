...
// ----------------------------------------------------------------------------
FileExportDialog::FileExportDialog(wxWindow* parentWindow, wxWindowID windowId,
                                   const FileExportItemList& encoders, const string& selectedEncoder,
      ...
      mEncoders(encoders)
{
    ...
    // list
    mListBox = new wxListBox(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, encoderArray,
...
// ----------------------------------------------------------------------------
void FileExportDialog::onListBoxDClick(wxCommandEvent& event) { EndModal(wxID_OK); }
