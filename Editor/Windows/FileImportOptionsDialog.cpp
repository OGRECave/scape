...
// ----------------------------------------------------------------------------
FileImportOptionsDialog::FileImportOptionsDialog(wxWindow* parentWindow, wxWindowID windowId, const wxString& caption,
    ...
    , mDirtyValueMap(false)
{
    ...
    if (showWidth || showHeight)
    {
        ...
        if (showWidth)
        {
            ...
            mWidthTextCtrl
                = new wxTextCtrl(this, wxID_ANY, valueWidth, wxDefaultPosition, wxDefaultSize, 0, integerValidator);
            mWidthTextCtrl->SetMaxLength(5);
            categorySizer->Add(mWidthTextCtrl, 0, wxALIGN_LEFT | wxRIGHT | wxALIGN_LEFT | wxALIGN_CENTER_VERTICAL, 5);
        }
        ...
        if (showHeight)
        {
            ...
            mHeightTextCtrl
                = new wxTextCtrl(this, wxID_ANY, valueHeight, wxDefaultPosition, wxDefaultSize, 0, integerValidator);
            mHeightTextCtrl->SetMaxLength(5);
            categorySizer->Add(mHeightTextCtrl, 0, wxALIGN_LEFT | wxRIGHT | wxALIGN_RIGHT | wxALIGN_CENTER_VERTICAL, 5);
        }
    ...
    if (showBpp)
    {
        ...
        while (labelSplit.length())
        {
            ...
            wxRadioButton* button = new wxRadioButton(
                this, wxID_ANY, option, wxDefaultPosition, wxDefaultSize, (firstInGroup ? wxRB_GROUP : 0));
    ...
    if (showEndian)
    {
        ...
        wxRadioButton* button = new wxRadioButton(
            this, wxID_ANY, _T("Little Endian (Intel)"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
