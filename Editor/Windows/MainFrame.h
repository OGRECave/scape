...
namespace ScapeEditor
{
	...
	// ----------------------------------------------------------------------------
	class MainFrame : public wxFrame, public UIElementPropertyGridListener, public UIElementToolBarListener, public UIElementPresetPanelListener
	{
	public:
		...
		virtual wxString onUpdatePropertyGridPropertyValue(const wxString& gridIdName, const wxString& propertyName, const wxString& value);
		...
		virtual void onPresetPanelChangePresetName(const wxString& presetPanelName, const wxString& oldPresetName, const wxString& newPresetName);
