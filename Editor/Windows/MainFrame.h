...
public:
    ...
    virtual wxString onUpdatePropertyGridPropertyValue(const wxString& gridIdName,
                                                       const wxString& propertyName, const wxString& value);
    virtual wxString onResetPropertyGridPropertyValue(const wxString& gridIdName,
                                                      const wxString& propertyName);

    // UIElementTooBarListener listener implementation
    virtual void onToolBarItemClicked(const wxString& toolBarName, const wxString& itemName,
                                      int itemCategory);
    ...
    virtual void onPresetPanelChangePresetName(const wxString& presetPanelName,
                                               const wxString& oldPresetName,
                                               const wxString& newPresetName);
