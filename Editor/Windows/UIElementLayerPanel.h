...
public:
    ...
    virtual void onLayerPanelChangeLayerName(const wxString& layerPanelName, const wxString& oldLayerName,
                                             const wxString& newLayerName) = 0;
...
class UIElementLayerPanel : public wxPanel
{
    ...
    UIElementLayerPanel(wxWindow* parentWindow, const wxString& name, const wxString& caption,
