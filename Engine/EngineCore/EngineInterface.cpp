...
// ----------------------------------------------------------------------------
void EngineInterface::createRenderView(
    int viewId, const std::string& windowHandle, int left, int top, int width, int height)
{
...
bool EngineInterface::selectOperation(const string& operationName)
{
    ...
    else
    {
        Ogre::LogManager::getSingleton().logMessage(
            _T("EngineInterface::selectOperation(): unknown specified operation '") + operationName + _T("'"));
        return false;
    }
}

// ----------------------------------------------------------------------------
string EngineInterface::getUIElementPropertyField(
    const string& elementName, const string& propertyName, const string& propertyFieldName)
{
    return getEngineCore()->getSettingsDatasetManager()->getSetting(
        _T("UI"), elementName, propertyName, propertyFieldName);
}
...
// ----------------------------------------------------------------------------
string EngineInterface::getUIElementPresetPropertyValue(
    EScapeUIElementGroupId groupId, const string& elementName, const string& presetName, const string& propertyName)
{
...
// ----------------------------------------------------------------------------
void EngineInterface::setUIElementPresetPropertyValue(EScapeUIElementGroupId groupId, const string& elementName,
    const string& presetName, const string& propertyName, const string& value)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
...
// ----------------------------------------------------------------------------
StringStringMap EngineInterface::getUIElementPresetPropertyValueMap(
    EScapeUIElementGroupId groupId, const string& elementName, const string& presetName)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
    if (container)
...
// ----------------------------------------------------------------------------
void EngineInterface::setUIElementPresetPropertyValueMap(EScapeUIElementGroupId groupId, const string& elementName,
...
// ----------------------------------------------------------------------------
StringStringMap EngineInterface::setUIElementPropertyValueMap(
    EScapeUIElementGroupId groupId, const string& elementName, const StringStringMap& valueMap)
{
    UIElementContainer* container = getUIElementContainer(groupId, elementName);
...
// ----------------------------------------------------------------------------
void EngineInterface::deleteUIElementPreset(
    EScapeUIElementGroupId groupId, const string& elementName, const string& presetName)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
...
// ----------------------------------------------------------------------------
string EngineInterface::importUIElementPreset(
    EScapeUIElementGroupId groupId, const string& elementName, const string& fileName)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
    if (container)
...
// ----------------------------------------------------------------------------
void EngineInterface::exportUIElementPreset(
    EScapeUIElementGroupId groupId, const string& elementName, const string& fileName)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
...
// ----------------------------------------------------------------------------
string EngineInterface::makeUniquePresetName(
    EScapeUIElementGroupId groupId, const string& elementName, const string& baseName)
{
    UIElementPresetContainer* container
        = dynamic_cast<UIElementPresetContainer*>(getUIElementContainer(groupId, elementName));
    if (container)
...
// ----------------------------------------------------------------------------
string EngineInterface::getUIElementPropertyValue(
    EScapeUIElementGroupId groupId, const string& elementName, const string& propertyName)
{
    UIElementContainer* container = getUIElementContainer(groupId, elementName);
...
// ----------------------------------------------------------------------------
string EngineInterface::setUIElementPropertyValue(
    EScapeUIElementGroupId groupId, const string& elementName, const string& propertyName, const string& value)
{
    UIElementContainer* container = getUIElementContainer(groupId, elementName);
...
UIElementContainer* EngineInterface::getUIElementContainer(EScapeUIElementGroupId groupId, const string& elementName)
{
    ...
    default:
    {
        Ogre::LogManager::getSingleton().logMessage(_T("EngineInterface::getUIElementContainer(): unknown element '")
            + elementName + _T(" in group '") + Ogre::StringConverter::toString(groupId) + _T("'"));
    }
    break;
    }
