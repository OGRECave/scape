...
namespace ScapeEngine {
    ...
    public:
        ...
        std::string getUIElementPresetPropertyValue(EScapeUIElementGroupId groupId, const std::string& elementName,
        ...
        void setUIElementPresetPropertyValue(EScapeUIElementGroupId groupId, const std::string& elementName,
            const std::string& presetName, const std::string& propertyName, const std::string& value);
        ...
        std::string getUIElementPropertyField(
            const std::string& elementName, const std::string& propertyName, const std::string& propertyFieldName);

        std::string getUIElementPropertyValue(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& propertyName);
        ...
        StringStringMap setUIElementPropertyValueMap(
            EScapeUIElementGroupId groupId, const std::string& elementName, const StringStringMap& valueMap);

        StringList getUIElementPresetPropertyNames(EScapeUIElementGroupId groupId, const std::string& elementName);

        StringStringMap getUIElementPresetPropertyValueMap(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& presetName);
        ...
        void deleteUIElementPreset(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& presetName);
        std::string importUIElementPreset(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& fileName);
        void exportUIElementPreset(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& fileName);

        std::string makeUniquePresetName(
            EScapeUIElementGroupId groupId, const std::string& elementName, const std::string& baseName);
