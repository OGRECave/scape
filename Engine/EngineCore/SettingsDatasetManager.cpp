...
SettingsDataset* SettingsDatasetManager::getDataset(const string& datasetName) const
{
	...
	{
		datasetIt = mDatasetMap.insert( mDatasetMap.begin(),
			DatasetMap::value_type(datasetName, new SettingsDataset(datasetName)));
...
// ----------------------------------------------------------------------------
string SettingsDatasetManager::getSetting(const string& datasetName, const string& section, const string& subsection, const string& key) const
{
...
// ----------------------------------------------------------------------------
void SettingsDatasetManager::setSetting(const string& datasetName, const string& section, const string& subsection, const string& key, const string& value)
{
