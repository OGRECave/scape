...
void SkySettings::onPreFrameTick()
{
    ...
    {
        Ogre::Real deltaX
            = getEngineCore()->getTimeSinceLastFrame() * inputManager->getAnalogInput(AnalogInputId::POINTER_DELTAX);
        Ogre::Real deltaY
            = getEngineCore()->getTimeSinceLastFrame() * inputManager->getAnalogInput(AnalogInputId::POINTER_DELTAY);
