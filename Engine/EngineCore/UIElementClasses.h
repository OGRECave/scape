...
namespace ScapeEngine
{
	...
	public:
		...
		virtual void				setUIElementPresetPropertyValue(const string& presetName, const string& elementName, const string& value) = 0;
		virtual StringStringMap		getUIElementPresetPropertyValueMap(const string& presetName) = 0;
		virtual void				setUIElementPresetPropertyValueMap(const string& presetName, const StringStringMap& valueMap) = 0;
	...
	public:
		...
		virtual void				setUIElementPresetPropertyValue(const string& presetName, const string& elementName, const string& value);
		virtual StringStringMap		getUIElementPresetPropertyValueMap(const string& presetName);
		virtual void				setUIElementPresetPropertyValueMap(const string& presetName, const StringStringMap& valueMap);
