...
Ogre::TexturePtr HeightfieldBufferPage::getHeightTexture()
{
    if (!containsData())
    {
        ...
        _mHeightTexture = Ogre::TextureManager::getSingleton().createManual(textureName,
            Ogre::ResourceGroupManager::DEFAULT_RESOURCE_GROUP_NAME, Ogre::TEX_TYPE_2D, bufferWidth, bufferHeight, 1,
            getPackedFormat(), Ogre::TU_STATIC);
