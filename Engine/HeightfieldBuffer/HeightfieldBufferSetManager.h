...
namespace ScapeEngine {
    ...
    public:
        ...
        HeightfieldBufferSetHandle create(const string& name, int elementColumnCount, int elementRowCount,
            Ogre::Real heightRangeMin, Ogre::Real heightRangeMax, int elementColumnCountPerPage,
