...
// ----------------------------------------------------------------------------
bool HeightfieldFileEncoderImageBase::encode(HeightfieldBuffer* inBuffer, const string& fileName, string* error)
{
    Ogre::LogManager::getSingleton().logMessage(_T("Exporting heightfield '") + inBuffer->getName() + _T("' to file '")
        + fileName + _T("' using encoder '") + getClassName() + _T("'"));
    assert(inBuffer);
...
IMPLEMENT_HEIGHTFIELDFILEENCODERIMAGE_CLASS(
    HeightfieldFileEncoderImageTIFF8U, _T("TIFF"), _T("*.TIF;*.TIFF"), Ogre::PF_L8);

IMPLEMENT_HEIGHTFIELDFILEENCODERIMAGE_CLASS(
    HeightfieldFileEncoderImagePGM16U, _T("PGM"), _T("*.PGM"), Ogre::PF_SHORT_L);
IMPLEMENT_HEIGHTFIELDFILEENCODERIMAGE_CLASS(
    HeightfieldFileEncoderImagePNG16U, _T("PNG"), _T("*.PNG"), Ogre::PF_SHORT_L);
IMPLEMENT_HEIGHTFIELDFILEENCODERIMAGE_CLASS(
    HeightfieldFileEncoderImageTIFF16U, _T("TIFF"), _T("*.TIF;*.TIFF"), Ogre::PF_SHORT_L);

IMPLEMENT_HEIGHTFIELDFILEENCODERIMAGE_CLASS(
    HeightfieldFileEncoderImageTIFF32F, _T("TIFF"), _T("*.TIF;*.TIFF"), Ogre::PF_FLOAT32_R);
