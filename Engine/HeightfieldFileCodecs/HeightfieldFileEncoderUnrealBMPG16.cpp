...
// ----------------------------------------------------------------------------
string HeightfieldFileEncoderUnrealBMPG16::setUIElementPropertyValue(const string& elementName, const string& value) 
{
...
// ----------------------------------------------------------------------------
bool HeightfieldFileEncoderUnrealBMPG16::encode(
	...
	string* error)
{
	...
	if (file)
	{
		...
		bool successful = HeightfieldFileEncoderRawBase::encode(inBuffer, file, mFlipX, mFlipY, mBigEndian, mPixelFormat, error);
