...
// ----------------------------------------------------------------------------
bool HeightfieldFileEncoderUnrealBMPG16::encode(HeightfieldBuffer* inBuffer, const string& fileName, string* error)
{
    ...
    if (file)
    {
        ...
        bool successful
            = HeightfieldFileEncoderRawBase::encode(inBuffer, file, mFlipX, mFlipY, mBigEndian, mPixelFormat, error);
