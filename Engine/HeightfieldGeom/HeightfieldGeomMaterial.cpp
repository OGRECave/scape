...
// ----------------------------------------------------------------------------
HeightfieldGeomMaterial::HeightfieldGeomMaterial() : mInitialized(false), mBrush(NULL), mHasDirtySettings(true)
{
    mMaterial.setNull();
}
    ...
    const HeightfieldGeom* heightfieldGeom, ShaderCustomAutoConstants* shaderCustomAutoConstants, bool forceAll)
{
    ...
    if (forceAll)
    {
        ...
        shaderCustomAutoConstants->setConstant(_HeightfieldGeomMaterialNS::LOCALPOSSCALE,
        ...
        shaderCustomAutoConstants->setConstant(
            _HeightfieldGeomMaterialNS::GRADIENTSCALEBIAS, Ogre::Vector4(unitQuadScaleHeight / worldQuadSize,
                                                               0.0f, // not used
                                                               0.0f, // not used
                                                               0.0f)); // not used
    }
    ...
    if (mBrush)
    {
        ...
        shaderCustomAutoConstants->setConstant(
            _HeightfieldGeomMaterialNS::BRUSHPOSRAMP, Ogre::Vector4(brushPosition.x, // U coordinate of brush center
        ...
        shaderCustomAutoConstants->setConstant(
            _HeightfieldGeomMaterialNS::BRUSHCOLOR, Ogre::Vector4(1.0f, // r
                                                        0.0f, // g
                                                        0.0f, // b
    ...
    {
        shaderCustomAutoConstants->setConstant(
            _HeightfieldGeomMaterialNS::BRUSHPOSRAMP, Ogre::Vector4(0, // U coordinate of brush center
                                                          0, // V coordinate of brush center
                                                          0, // brush ramp scale
                                                          0)); // brush ramp bias

        shaderCustomAutoConstants->setConstant(_HeightfieldGeomMaterialNS::BRUSHCOLOR, Ogre::Vector4(1.0f, // r
                                                                                           0.0f, // g
                                                                                           0.0f, // b
    ...
    const HeightfieldGeomTile* heightfieldGeomTile, ShaderCustomAutoConstants* shaderCustomAutoConstants, bool forceAll)
{
    ...
    if (forceAll)
    {
        ...
        const Ogre::Real unitQuadBiasHeight
            = (unitQuadRangeMaxHeight - unitQuadRangeMinHeight) * rawRangeBias - 0.5f * unitQuadRangeMinHeight;
        ...
        shaderCustomAutoConstants->setConstant(_HeightfieldGeomMaterialNS::UNITQUADSCALE,
        ...
        shaderCustomAutoConstants->setConstant(_HeightfieldGeomMaterialNS::UNITQUADBIAS,
...
void HeightfieldGeomMaterial::bindShaderConstants()
{
    ...
    Utils::bindShaderCustomAutoConstant(
        technique, _HeightfieldGeomMaterialNS::GRADIENTSCALEBIAS, _T("gradientScaleBias"));
