...
struct CachedBufferDescription
{
    ...
    inline bool operator==(const CachedBufferDescription& rhs) const
    {
        return type == rhs.type && visibleQuadRect.left == rhs.visibleQuadRect.left &&
               ...
               quadColumnSpacing == rhs.quadColumnSpacing && quadRowSpacing == rhs.quadRowSpacing;
    }
    ...
    int templateQuadRowCount, int quadColumnSpacing, int quadRowSpacing)
{
    ...
    CachedBufferDescription key = {
        type,          visibleQuadRect, templateQuadColumnCount, templateQuadRowCount, quadColumnSpacing,
        quadRowSpacing};
    ...
    if (bufferIt == mCachedBuffers->end())
    {
        ...
        value.buffer = createBuffer(type, visibleQuadRect, templateQuadColumnCount, templateQuadRowCount,
