...
namespace ScapeEngine {
    namespace HeightfieldGeomTileVertexUVBufferManagerNS {
        ...
        struct CachedBufferDescription
        {
            ...
            {
                return type == rhs.type && visibleQuadRect.left == rhs.visibleQuadRect.left
                    ...
                    && templateQuadRowCount == rhs.templateQuadRowCount && quadColumnSpacing == rhs.quadColumnSpacing
...
// ----------------------------------------------------------------------------
HeightfieldGeomTileVertexUVBufferManager::HeightfieldGeomTileVertexUVBufferManager() : mBufferTimeToLive(1.0f)
{
    wantsPostFrameTick();
...
// ----------------------------------------------------------------------------
Ogre::HardwareVertexBufferSharedPtr HeightfieldGeomTileVertexUVBufferManager::getBuffer(Ogre::VertexElementType type,
    const Ogre::Rect& visibleQuadRect, int templateQuadColumnCount, int templateQuadRowCount, int quadColumnSpacing,
    int quadRowSpacing)
{
    CachedBufferDescription key
        = { type, visibleQuadRect, templateQuadColumnCount, templateQuadRowCount, quadColumnSpacing, quadRowSpacing };
    ...
    int templateQuadRowCount, int quadColumnSpacing, int quadRowSpacing)
{
    ...
    Ogre::HardwareVertexBufferSharedPtr buffer = Ogre::HardwareBufferManager::getSingleton().createVertexBuffer(
        elementTypeSize, vertexCount, Ogre::HardwareBuffer::HBU_STATIC_WRITE_ONLY, false);
