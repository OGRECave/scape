...
namespace ScapeEngine {
    ...
    public:
        ...
        Ogre::HardwareVertexBufferSharedPtr getBuffer(Ogre::VertexElementType type, const Ogre::Rect& visibleQuadRect,
            int templateQuadColumnCount, int templateQuadRowCount, int quadColumnSpacing, int quadRowSpacing);
    ...
    private:
        ...
        Ogre::HardwareVertexBufferSharedPtr createBuffer(Ogre::VertexElementType type,
            const Ogre::Rect& visibleQuadRect, int templateQuadColumnCount, int templateQuadRowCount,
