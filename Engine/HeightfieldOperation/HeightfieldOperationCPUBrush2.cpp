        ...
        while (!mBrushInstances.empty())
        {
            ...
            Ogre::Real sizeChangeScale =
                ...
                mOperation->getStrength(); // * 0.01f;//* changeSpeed;// * (1.0f -
                                           // expf(-getEngineCore()->getTimeSinceLastFrame() /
                                           // changeSpeed));
            ...
            Ogre::Rect relativeRect = Utils::translatedRect(Utils::intersectTRect(newUpdateRect, pageRect),
