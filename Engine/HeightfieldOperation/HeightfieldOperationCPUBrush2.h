...
class HeightfieldOperationCPUBrush2
    : public HeightfieldOperationPolicyBrushInstancerSpacer<
          HeightfieldOperationCPUBrush2, HeightfieldOperationPolicySchedulerTaskPageBatch<
                                             HeightfieldOperationCPUBrush2, HeightfieldOperationBrushBase>>
{
...
public:
    ...
    virtual HeightfieldOperationTaskPage* createTaskPage(const BrushPageCoords& pageCoords,
