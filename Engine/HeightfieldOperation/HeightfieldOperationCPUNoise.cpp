...
// ----------------------------------------------------------------------------
string HeightfieldOperationCPUNoise::setUIElementPropertyValue(const string& elementName, const string& value) 
{
	...
	case PROPERTYID_MIN_RANGE: {intValue = Utils::clamp(intValue, 1, 1000); mPropMinRange = (Ogre::Real)intValue; outValue = Ogre::StringConverter::toString(intValue); break;}
	case PROPERTYID_MAX_RANGE: {intValue = Utils::clamp(intValue, 1, 1000); mPropMaxRange = (Ogre::Real)intValue; outValue = Ogre::StringConverter::toString(intValue); break;}
	case PROPERTYID_HI_AMP: {intValue = Utils::clamp(intValue, 1, 199); mPropHiAmp = (Ogre::Real)intValue * 0.01f; outValue = Ogre::StringConverter::toString(intValue); break;}
	case PROPERTYID_MID_AMP: {intValue = Utils::clamp(intValue, 1, 199); mPropMidAmp = (Ogre::Real)intValue * 0.01f; outValue = Ogre::StringConverter::toString(intValue); break;}
...
// ----------------------------------------------------------------------------
HeightfieldOperationCPUNoise::HeightfieldOperationCPUNoise()
...
/*
// ----------------------------------------------------------------------------
void HeightfieldOperationCPUNoise::applySecondary(const Ogre::Vector3& position, Ogre::Real strength, const Ogre::Vector3& delta)
{
	mNoiseOrigin += delta;
