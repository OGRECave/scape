...
IMPLEMENT_UIELEMENTCONTAINERSIMPLE_CLASS(HeightfieldOperationCPUSmooth)
...
// ----------------------------------------------------------------------------
string HeightfieldOperationCPUSmooth::setUIElementPropertyValue(const string& elementName, const string& value) 
{
...
// ----------------------------------------------------------------------------
HeightfieldOperationCPUSmooth::HeightfieldOperationCPUSmooth()
...
Ogre::Rect editRect(
	...
	for (int x = 1; x < (int)editRect.width() - 1; ++x)
	{
		for (int z = 1; z < (int)editRect.height() - 1; ++z)
		{
			...
			Ogre::Real avgHeight = 0.2f * (hy + dataIn[index+1] + dataIn[index-1] + dataIn[index+width] + dataIn[index-width]);
