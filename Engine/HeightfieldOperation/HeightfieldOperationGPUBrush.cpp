...
{
    HeightfieldOperationTaskPageGPUBrush* page =
        new HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationBrush"), _T("GPU2DOperationAddMask"), 16,
                                                 false, this, this, pageCoords, brushInstances);
    //	HeightfieldOperationTaskPageGPUBrush* page = new
    //HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationAddMask"), _T(""), true, this, this,
