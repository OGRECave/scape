...
string HeightfieldOperationGPUBrush::setUIElementPropertyValue(const string& elementName, const string& value) 
{
	...
	case PROPERTYID_SHOWDEBUG: {mShowDebug = boolValue; outValue = Ogre::StringConverter::toString(boolValue); break;}
...
:	HeightfieldOperationPolicyBrushInstancerSpacer<HeightfieldOperationGPUBrush, HeightfieldOperationPolicySchedulerTaskPageBatch<HeightfieldOperationGPUBrush, HeightfieldOperationBrushBase> >(),
	mShowDebug(false)
{
...
// ----------------------------------------------------------------------------
HeightfieldOperationTaskPage* HeightfieldOperationGPUBrush::createTaskPage(const BrushPageCoords& pageCoords, const BrushInstances& brushInstances)
{
	HeightfieldOperationTaskPageGPUBrush* page = new HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationBrush"), _T("GPU2DOperationAddMask"), 16, false, this, this, pageCoords, brushInstances);
//	HeightfieldOperationTaskPageGPUBrush* page = new HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationAddMask"), _T(""), true, this, this, pageCoords, brushInstances);
