                                             ...
                                             const BrushInstances& brushInstances)
{
    ...
    return new HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationBrush"), matName, 16, false, this,
                                                    this, pageCoords, brushInstances);
    //	return new HeightfieldOperationTaskPageGPUBrush(matName, _T(""), true, this, this, pageCoords,
    //brushInstances);
}
