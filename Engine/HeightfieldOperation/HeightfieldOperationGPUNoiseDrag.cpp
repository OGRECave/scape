...
HeightfieldOperationGPUNoiseDrag::HeightfieldOperationGPUNoiseDrag()
    : HeightfieldOperationPolicyBrushInstancerSpacer<HeightfieldOperationGPUNoiseDrag,
...
// ----------------------------------------------------------------------------
HeightfieldOperationTaskPage* HeightfieldOperationGPUNoiseDrag::createTaskPage(
    const BrushPageCoords& pageCoords, const BrushInstances& brushInstances)
{
    ...
    return new HeightfieldOperationTaskPageGPUBrush(
        _T("GPU2DOperationNoiseDrag"), _T(""), 8, true, this, this, pageCoords, brushInstances);
    //	return new HeightfieldOperationTaskPageGPUBrush(_T("GPU2DOperationBrush"), matName, false, this, this,
    //pageCoords, brushInstances);
}
...
void HeightfieldOperationGPUNoiseDrag::onSetupGPU2DOperationQuadBrush(GPU2DOperationQuadBrushPtr quadPtr)
{
    ...
    quadPtr->setMaterialShaderConstant(
        _T("directionTrans"), Ogre::Vector4(cos(DEGTORAD(mDirectionStretchAngle)) * sqrtf(mDirectionStretchRatio),
    ...
    quadPtr->setMaterialShaderConstant(_T("scales"),
        Ogre::Vector4(mDistortScaleFine, mDistortScaleCoarse, 0.5f * mNoiseAllowUp, 0.5f * mNoiseAllowDown));
