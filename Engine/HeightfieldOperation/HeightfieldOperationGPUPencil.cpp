...
string HeightfieldOperationGPUPencil::setUIElementPropertyValue(const string& elementName, const string& value)
{
    ...
    case PROPERTYID_LEVELEFFECT:
    {
        intValue = Utils::clamp(intValue, 0, 100);
        mLevelEffect = intValue * 0.01f;
        outValue = Ogre::StringConverter::toString(intValue);
        break;
    }
    default:
...
HeightfieldOperationGPUPencil::HeightfieldOperationGPUPencil()
    : HeightfieldOperationPolicyBrushInstancerSpacer<HeightfieldOperationGPUPencil,
...
// ----------------------------------------------------------------------------
HeightfieldOperationTaskPage* HeightfieldOperationGPUPencil::createTaskPage(
    const BrushPageCoords& pageCoords, const BrushInstances& brushInstances)
{
    return new HeightfieldOperationTaskPageGPUBrush(
        _T("GPU2DOperationPencil"), _T(""), 16, true, this, this, pageCoords, brushInstances);
}
