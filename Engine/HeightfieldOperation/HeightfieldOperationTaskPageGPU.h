...
{
public:
    HeightfieldOperationTaskPageGPU(HeightfieldOperationTaskPageGPUListener* quadListener,
                                    HeightfieldOperationBrush* operation, const BrushPageCoords pageCoords,
                                    const BrushInstances& brushInstances)
        : HeightfieldOperationTaskPage(operation, pageCoords, brushInstances), mQuadListener(quadListener)
    {
    }
