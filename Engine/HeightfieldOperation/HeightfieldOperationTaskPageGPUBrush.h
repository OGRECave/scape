...
namespace ScapeEngine
{
	...
	public:
		...
		HeightfieldOperationTaskPageGPUBrush(const string& brushMaterialName, const string& blendMaterialName, int supportedBrushInstanceCount, bool onePass, HeightfieldOperationTaskPageGPUListener* quadListener, HeightfieldOperationBrush* operation, const BrushPageCoords pageCoords, const BrushInstances& brushInstances);
	...
	protected:
		...
		void setOperationQuadNeighbor(GPU2DOperationQuadCustomPtr &quadPtr, const string& constantCoordName, const string& textureAliasName, int deltaX, int deltaY);
	};
}
