...
// ----------------------------------------------------------------------------
void ScapeEngine::ButtonDefinitionXMLSerializer::importSceneFromResource(
...
void ScapeEngine::ButtonDefinitionXMLSerializer::importXML(const string& rawData)
{
    ...
    if (tiXMLDoc.Error())
    {
        Ogre::LogManager::getSingleton().logMessage(_T("ButtonDefinitionXMLReader::importXML: TinyXML error ")
...
void _readElementBUTTON(const TiXmlElement& buttonElem)
{
    ...
    for (const TiXmlElement* buttonDefinitionElem = buttonElem.FirstChildElement(_T("DEF")); buttonDefinitionElem;
         buttonDefinitionElem = buttonDefinitionElem->NextSiblingElement(_T("DEF")))
    {
...
void _readElementDEF(const TiXmlElement& buttonDefinitionElem, ButtonId::EButtonId buttonId)
{
    ...
    for (const TiXmlElement* deviceButtonElem = buttonDefinitionElem.FirstChildElement(_T("DBUTTON")); deviceButtonElem;
         deviceButtonElem = deviceButtonElem->NextSiblingElement(_T("DBUTTON")))
    {
