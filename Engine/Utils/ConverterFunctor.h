...
namespace ScapeEngine
{
	namespace Utils
	{
		// ----------------------------------------------------------------------------
		template<class Type>
		class ConverterFunctorPassThrough
		{
		public:
			typedef Type TypeIn;
		...
		// ----------------------------------------------------------------------------
		template<class InType, class OutType, class ConversionType = OutType>
		class ConverterFunctorScaleBias
		{
		public:
		...
		class NormalizedScalarConverterFunctor {};
		...
		// ----------------------------------------------------------------------------
		template<>
		class NormalizedScalarConverterFunctor<Ogre::uint16, short> : public ConverterFunctorBias<Ogre::uint16, short>
		{
		public:
		...
		template<>
		class NormalizedScalarConverterFunctor<Ogre::uint16, Ogre::Real> : public ConverterFunctorScale<Ogre::uint16, Ogre::Real>
		{
		public:
		...
		// ----------------------------------------------------------------------------
		template<>
		class NormalizedScalarConverterFunctor<short, Ogre::uint16> : public ConverterFunctorBias<short, Ogre::uint16>
		{
		public:
			NormalizedScalarConverterFunctor() : ConverterFunctorBias(32768) {}
		};
		...
		template<>
		class NormalizedScalarConverterFunctor<short, Ogre::Real> : public ConverterFunctorScaleBias<short, Ogre::Real>
		{
		public:
		...
		// ----------------------------------------------------------------------------
		template<>
		class NormalizedScalarConverterFunctor<Ogre::Real, short> : public ConverterFunctorScaleBias<Ogre::Real, short, Ogre::Real>
		{
		public:
		...
		template<>
		class NormalizedScalarConverterFunctor<Ogre::Real, Ogre::uint16> : public ConverterFunctorScale<Ogre::Real, Ogre::uint16, Ogre::Real>
		{
		public:
