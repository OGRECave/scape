...
namespace ScapeEngine {
    ...
    public:
        ...
        inline TMatrix4<T>(
            const TVector4<T>& _col0, const TVector4<T>& _col1, const TVector4<T>& _col2, const TVector4<T>& _col3)
        ...
        inline Ogre::Matrix4 toOgreMatrix4() const
        {
            return Ogre::Matrix4(static_cast<Ogre::Real>(col0.x), static_cast<Ogre::Real>(col1.x),
                ...
                static_cast<Ogre::Real>(col0.y), static_cast<Ogre::Real>(col1.y), static_cast<Ogre::Real>(col2.y),
                static_cast<Ogre::Real>(col3.y),

                static_cast<Ogre::Real>(col0.z), static_cast<Ogre::Real>(col1.z), static_cast<Ogre::Real>(col2.z),
                static_cast<Ogre::Real>(col3.z),

                static_cast<Ogre::Real>(col0.w), static_cast<Ogre::Real>(col1.w), static_cast<Ogre::Real>(col2.w),
        ...
        inline void fromEulerAngles(const TVector3<T>& eulerAngles, TVector3<T> translation = TVector3<T>::ZERO)
        {
            ...
            TMatrix4<T> yawMat(TVector4<T>(cosy, 0, -siny, 0), TVector4<T>(0, 1, 0, 0), TVector4<T>(siny, 0, cosy, 0),
                TVector4<T>::UNIT_W);

            TMatrix4<T> pitchMat(TVector4<T>(1, 0, 0, 0), TVector4<T>(0, cosp, sinp, 0), TVector4<T>(0, -sinp, cosp, 0),
                TVector4<T>::UNIT_W);
    ...
    const TMatrix4<T> TMatrix4<T>::IDENTITY(
        TVector4<T>(1, 0, 0, 0), TVector4<T>(0, 1, 0, 0), TVector4<T>(0, 0, 1, 0), TVector4<T>(0, 0, 0, 1));

    // Constant zero matrix
    template <class T>
    const TMatrix4<T> TMatrix4<T>::ZERO(
        TVector4<T>(0, 0, 0, 0), TVector4<T>(0, 0, 0, 0), TVector4<T>(0, 0, 0, 0), TVector4<T>(0, 0, 0, 0));
