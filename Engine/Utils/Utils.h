...
namespace ScapeEngine {
    ...
    namespace Utils {
        // ----------------------------------------------------------------------------
        inline int findEnumFromStringEnumMap(
            const StringEnumMap& stringEnumMap, const string& name, int notFoundValue = -1)
        {
        ...
        template <class T> inline const T& min(const T& left, const T& right) { return (left < right ? left : right); }
        // ----------------------------------------------------------------------------
        // Get the larger of the two values/objects
        template <class T> inline const T& max(const T& left, const T& right) { return (left > right ? left : right); }
        // ----------------------------------------------------------------------------
        ...
        public:
            ...
            MapStructReadIterator(const MapStructType& mapStruct)
                : mValid(true)
                , mBeginIt(mapStruct.map.begin())
                , mCurrentIt(mapStruct.map.begin())
        ...
        // ----------------------------------------------------------------------------
        Ogre::PixelBox clipPixelBox(
            const Ogre::PixelBox& pixelBox, const Ogre::Rect& relativeRect, int offsetX = 0, int offsetY = 0);
